...
/**
 * Unit test for {@link NeverFollowRedirectStrategy}.
 *
 * @author Gabor Keszthelyi
 */
@RunWith(JMockit.class)
public class NeverFollowRedirectStrategyTest
{

    private NeverFollowRedirectStrategy underTest = new NeverFollowRedirectStrategy();
