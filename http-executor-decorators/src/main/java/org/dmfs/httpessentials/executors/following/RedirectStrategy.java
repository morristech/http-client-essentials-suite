...
public interface RedirectStrategy
{
    ...
    /**
     * Determines whether this {@link RedirectStrategy} affects the given {@link HttpResponse}. The result of this is undefined if the response has a status
     * code that is not in the rage of redirection status codes.
     *
     * @param response
     *         An {@link HttpResponse} with any redirection status code (i.e. 3xx).
     *
     * @return {@code true} if this {@link RedirectStrategy} affects the given response, {@code false} otherwise.
     */
